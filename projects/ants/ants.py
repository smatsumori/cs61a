        ...
        if insect.is_ant:
            ...
            if self.ant is insect:
                if hasattr(self.ant, 'container') and self.ant.container:
                    ...
                    if isinstance(insect, QueenAnt) and not insect.imposer:
                        # handle True queen
                        return None
                    else:
                        self.ant = None
...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        # BEGIN Problem 6A
        # NinjaAnt will not block a path
...
class Ant(Insect):
    ...
    def can_contain(self, other):
        return not self.ant and not other.container and self.container
...
class FireAnt(Ant):
    ...
    def __init__(self, armor=1):
        super(FireAnt, self).__init__(armor)
    ...
    def reduce_armor(self, amount):
        ...
        self.armor -= amount
        if self.armor <= 0:
            place_bees = list(self.place.bees)
...
class LongThrower(ThrowerAnt):
    ...
    def __init__(self, armor=1):
        super(LongThrower, self).__init__(armor)
    ...
    def nearest_bee(self, hive):
        ...
        cnt = 0
        while current_place.entrance:
            if self.min_range < cnt and current_place.bees:
                return random_or_none(current_place.bees)
            current_place = current_place.entrance
            cnt += 1
            # END Problem 4B
...
class ShortThrower(ThrowerAnt):
    ...
    def __init__(self, armor=1):
        super(ShortThrower, self).__init__(armor)
    ...
    def nearest_bee(self, hive):
        current_place = self.place
        cnt = 0
        while current_place.entrance and cnt < self.max_range:
            if current_place.bees:
                return random_or_none(current_place.bees)
            current_place = current_place.entrance
            cnt += 1
...
class WallAnt(Ant):
    ...
    def __init__(self, armor=4):
        super(WallAnt, self).__init__(armor)
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def __init__(self, armor=1):
        # BEGIN Problem 9
        self.imposer = False
        if QueenAnt.summoned:
            self.imposer = True
        QueenAnt.summoned = True
        super(QueenAnt, self).__init__(armor)
        # END Problem 9

    def empower(self):
        # all the ants behind her
        curr = self.place.exit
        while curr is not None:
            if curr.ant:
                if curr.ant not in QueenAnt.empowered_list:
                    curr.ant.damage *= 2
                    QueenAnt.empowered_list.append(curr.ant)
                if hasattr(curr.ant, 'container') and curr.ant.container and curr.ant.ant and curr.ant.ant not in QueenAnt.empowered_list:
                    curr.ant.ant.damage *= 2
                    QueenAnt.empowered_list.append(curr.ant.ant)
            curr = curr.exit
...
def apply_effect(effect, bee, duration):
    ...
    # BEGIN Problem EC
    old_action, new_action = bee.action, effect(bee.action)

    def get_action(colony):
        nonlocal duration
        if duration <= 0:
            old_action(colony)
        else:
