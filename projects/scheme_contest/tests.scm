...
; scheme test for composition points
...
(define make-addar-two (addar 2))
; expect make-addar-two
...
(define (fact-tail n)
   (define (helper n prod)
     ...
     (helper n 1))
(fact 123)
; expect 12146304367025329675766243241881295855454217088483382315328918161829235892362167668831156960612640202170735835221294047782591091570411651472186029519906261646730733907419814952960000000000000000000000000000

(fact-tail 123)
; expect 12146304367025329675766243241881295855454217088483382315328918161829235892362167668831156960612640202170735835221294047782591091570411651472186029519906261646730733907419814952960000000000000000000000000000

(define (fib n)
   (define (fib-help n prev curr)
    (if (= n 1) curr
    (fib-help (- n 1) curr (+ prev curr))
	    )
    )
	   (fib-help n 0 1)
)
; expect fib
(fib 123)
; expect 22698374052006863956975682
